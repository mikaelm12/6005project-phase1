...
public interface BoardGrammarListener extends ParseTreeListener {
	...
	void enterFriction2(BoardGrammarParser.Friction2Context ctx);
	void exitFriction2(BoardGrammarParser.Friction2Context ctx);
	...
	void enterGravity(BoardGrammarParser.GravityContext ctx);
	void exitGravity(BoardGrammarParser.GravityContext ctx);
}